...
| [#75](../../issues/75) | 방 프리팹 **5~6개** 제작 — 진행 중 | 5h |
| [#74](../../issues/74) | 적 3종 (돌진 / 원거리 / 방패) — **절단 후보 (→ 2종)** | 4h |
| [#77](../../issues/77) | 벽에 붙어 있으면 점프가 안 되는 경우 | 1h |

**견적 합 27.5h · 완료 17.5h · 남은 견적 10h.** 20h 예산이므로 남은 것을 그대로 다 하면
7.5h 초과다. **초과분은 [#74](../../issues/74) 가 받는다** — 3종을 2종으로 줄인다.
